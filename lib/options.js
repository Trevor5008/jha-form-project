...
const foremenData = ["G, Steve", "M, Ben", "S, Tony", "M, Karl"];
...
const competentPeople = [
   { label: "Crist, Bill", id: 1 },
   { label: "Gomez, Jen", id: 4 },
   { label: "Smith, John", id: 5 },
   { label: "Doe, Jane", id: 6 },
   { label: "Brown, Charlie", id: 7 },
   { label: "Johnson, Alex", id: 8 },
   { label: "Davis, Kim", id: 9 },
   { label: "Miller, Casey", id: 10 },
   { label: "Wilson, Terry", id: 11 },
   { label: "Taylor, Morgan", id: 12 },
];
